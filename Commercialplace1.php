...
<html lang="en">
    <head>
        ...
        <title>Bulacan Commercial Space</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Bulacan Commercial Space</h1>
                        <hr />
                        ...
                        <?php 
                            $i = 1;
                            $query = mysqli_query($con, "SELECT * FROM commercial_tbl WHERE space_location = 'bulacan'");
