<?php session_start();
    ...
    if (isset($_POST['submit'])) {
        ...
        $msg = mysqli_query($con, "INSERT INTO commercial_tbl (space_name, space_price, space_location, space_size, space_address, space_description, remarks, space_images) VALUES ('$space_name', '$price', '$location', '$size', '$address', '$description', 'Available', '$filesArray')");
    ...
    if(isset($_GET['id'])) {
        $delid=$_GET['id'];
        $msg = mysqli_query($con, "delete from commercial_tbl where id='$delid'");
        if($msg) {
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Commercial Spaces</h1>
                        <hr>
                        <!-- <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Upload here the commercials spaces</li>
                        </ol> -->
                   
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                    Uploaded Commercial space
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php 
                                            $i = 1;
                                            $query = mysqli_query($con, "SELECT * FROM commercial_tbl");

                                            foreach ($query as $row):  $i++; ?>
                                        <tr>
                                            <td><?php echo $row['space_name']; ?></td>
                                            <td><?php echo $row['space_price'];?></td>
                                            <td><?php echo $row['space_location'];?></td>
                                            <td><?php echo $row['space_size'];?></td>
                                            <td><?php echo $row['space_address'];?></td>
                                            <td><?php echo $row['space_description'];?></td>
                                            <td><?php echo $row['remarks'];?></td>
                                            <td>
                                                <?php $images = explode(',', $row['space_images']); ?>
                                            ...
                                            <td>
                                                ...
                                                <a href="manage_spaces.php?id=<?php echo $row['id'];?>" class="btn btn-danger" onClick="return confirm('Do you really want to delete');"><i class="fa fa-trash"></i></a>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">ADD COMMERCIAL SPACE</h5>
